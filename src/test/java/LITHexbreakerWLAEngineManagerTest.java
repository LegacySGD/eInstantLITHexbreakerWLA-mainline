...
public class LITHexbreakerWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITHexbreakerWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITHexbreakerWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITHexbreakerWLAIW/InitOutcome.xml").getDocumentElement();
